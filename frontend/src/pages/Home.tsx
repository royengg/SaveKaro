...
export function Home() {
  const { category, store, minDiscount, search, sortBy, setSearch, setCategory, setStore, setMinDiscount } = useFilterStore();
  ...
  const activeFilters = [
    ...
    minDiscount && { label: `${minDiscount}%+ off`, onRemove: () => setMinDiscount(null) },
      ...
      <div className="md:ml-24">
        ...
        <header className="sticky top-0 z-40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
          <div className="flex items-center justify-between h-20 px-4 md:px-8">
            ...
            {/* Search Bar */}
            <form onSubmit={handleSearch} className="hidden md:flex flex-1 max-w-3xl mx-auto">
            ...
            <div className="flex items-center gap-2">
              {isAuthenticated ? (
                ...
                <Button onClick={handleGoogleLogin} className="rounded-full gap-2">
