...
export const MOBILE_CHROME_FULL_RESTORE_PX = 120;
export const MOBILE_CHROME_COMPACT_AFTER_PX = 96;
export const MOBILE_CHROME_HIDE_INTENT_PX = 32;
export const MOBILE_CHROME_PRIMARY_INTENT_PX = 72;
